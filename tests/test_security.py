...
@pytest.fixture
def stats_with_temp_dir(temp_data_dir):
...
def test_encryption_and_decryption(stats_with_temp_dir):
...
def test_data_tampering_detection(stats_with_temp_dir):
...
def test_error_handling(stats_with_temp_dir):
...
def test_directory_hiding():
    ...
    try:
        ...
        try:
            ctypes.windll.kernel32.SetFileAttributesW(temp_dir, 0x02)  # 0x02 = FILE_ATTRIBUTE_HIDDEN
...
def test_statistics_initialization_with_missing_directory():
