...
class ControlsScreen:
    ...
    def __init__(self, ai_configuration, screen):
        ...
        # Create the title
        self.title = self.title_font.render("Game Controls", True, self.title_color)
        ...
        self.continue_text = self.continue_font.render("Press SPACE to continue", True, self.text_color)
