...
class Bullet(Sprite):
    ...
    _bullet_pool = []
    _max_pool_size = 100  # Maximum number of bullets to keep in the pool

    @classmethod
    def get_bullet(cls, ai_configuration, screen, ship):
    ...
    def reset(self, ai_configuration, screen, ship):
